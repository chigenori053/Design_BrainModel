...
use super::architecture_evaluator::{ArchitectureEvaluator, DefaultArchitectureEvaluator};
use super::audit::{AuditCore, AuditDecision, AuditTelemetryEvent};
use super::pruning::{
...
use super::search_controller::SearchController;
...
impl BeamSearchController {
    ...
    pub fn memory(&self) -> Arc<Mutex<InMemoryMemorySpace>> {
        self.memory.clone()
    }

    pub fn policy_store(&self) -> Arc<Mutex<PolicyStore>> {
    ...
    pub fn search_runtime(
        ...
        self.search_trace_with_context_runtime(
            initial_state,
            recall,
            config,
    ...
    pub fn search_trace_with_context_runtime(
        &self,
        initial_state: WorldState,
        recall: Option<&RecallResult>,
        config: &SearchConfig,
        ...
        self.search_trace_with_context(initial_state, recall, config, ctx)
    }
}
