...
mod command_flow;
#[path = "integration/cycle_recommendation_bridge.rs"]
mod cycle_recommendation_bridge;
#[path = "integration/git_commit_preview.rs"]
...
#[path = "integration/transaction_preview_bridge.rs"]
mod transaction_preview_bridge;
#[path = "integration/transactional_safe_apply.rs"]
